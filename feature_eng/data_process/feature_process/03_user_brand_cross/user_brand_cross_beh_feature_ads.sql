...
create table if not exists user_brand_cross_beh_feature_ads (
    ...
    clk_item_90d bigint, -- 用户近90天点击的该品牌的商品数量
    clk_item_60d bigint,
    clk_item_30d bigint,
    clk_item_15d bigint,
    clk_item_7d bigint,
    ...
    clk_num_90d bigint, -- 用户近90天点击的该品牌的商品次数
    clk_num_60d bigint,
    clk_num_30d bigint,
    clk_num_15d bigint,
    clk_num_7d bigint,
    ...
    clk_day_90d bigint,-- 用户近90天点击该品牌商品的天数
    clk_day_60d bigint,
    clk_day_30d bigint,
    clk_day_15d bigint,
    clk_day_7d bigint,
    ...
    clt_item_90d bigint,
    clt_item_60d bigint, -- 用户近60天收藏该品牌商品的数量
    clt_item_30d bigint,
    clt_item_15d bigint,
    clt_item_7d bigint,
    clt_item_3d bigint,
    ...
    cart_item_60d bigint,  -- 用户近60天 加购该品牌商品的数量
